...
JsonObject& JsonObject::operator=(std::string theData) {
	if (this->theType == ValueType::Object) {
		...
		theObject.theValue = theObject.theType;
		this->theType = ValueType::Unset;
		*theObject.theValue.theString = theData;
		std::cout << "THE KEY NAME: 344545: " << this->theKey << "THE EVENT: " << (int32_t)this->theType << "THE VALUE : " << *theObject.theValue.theString << std::endl;
		this->theValues[this->theKey] = theObject;
		return this->theValues[this->theKey];
	}
	else {
