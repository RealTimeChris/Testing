...
#include "JsonObject.hpp"
	...
	void ErlPacker::appendBinaryExt(String&& bytes, Uint32 sizeNew) {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Binary_Ext) };
	...
	void ErlPacker::appendUnsignedLongLong(Uint64 value) {
		...
		bufferNew[0] = static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Small_Big_Ext);
	...
	void ErlPacker::appendSmallIntegerExt(Uint8 value) {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Small_Integer_Ext), static_cast<char>(value) };
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendIntegerExt(Uint32 value) {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Integer_Ext) };
		DiscordCoreAPI::storeBits(bufferNew, value);
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendListHeader(Uint32 sizeNew) {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::List_Ext) };
		DiscordCoreAPI::storeBits(bufferNew, sizeNew);
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendMapHeader(Uint32 sizeNew) {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Map_Ext) };
		DiscordCoreAPI::storeBits(bufferNew, sizeNew);
		this->writeToBuffer(std::move(bufferNew));
	}
	...
	void ErlPacker::appendNewFloatExt(Double FloatValue) {
		String bufferNew{};
		bufferNew.push_back(static_cast<unsigned char>(DiscordCoreInternal::ETFTokenType::New_Float_Ext));
	...
	void ErlPacker::appendNilExt() {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Nil_Ext) };
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendFalse() {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Small_Atom_Ext), 5, static_cast<Uint8>('f'), static_cast<Uint8>('a'), static_cast<Uint8>('l'), static_cast<Uint8>('s'),
			static_cast<Uint8>('e') };
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendTrue() {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Small_Atom_Ext), 4, static_cast<Uint8>('t'), static_cast<Uint8>('r'), static_cast<Uint8>('u'), static_cast<Uint8>('e') };
		this->writeToBuffer(std::move(bufferNew));
	}

	void ErlPacker::appendNil() {
		String bufferNew{ static_cast<Uint8>(DiscordCoreInternal::ETFTokenType::Small_Atom_Ext), 3, static_cast<Uint8>('n'), static_cast<Uint8>('i'), static_cast<Uint8>('l') };
		this->writeToBuffer(std::move(bufferNew));
	}
	...
	String ErlPacker::singleValueETFToJson() {
		...
		switch (static_cast <DiscordCoreInternal::ETFTokenType > (type)) {
			case DiscordCoreInternal::ETFTokenType::Small_Integer_Ext : {
				return this->parseSmallIntegerExt();
			}
			case DiscordCoreInternal::ETFTokenType::Integer_Ext: {
				return this->parseIntegerExt();
			}
			case DiscordCoreInternal::ETFTokenType::New_Float_Ext: {
				return this->parseNewFloatExt();
			}
			case DiscordCoreInternal::ETFTokenType::Float_Ext: {
				return this->parseFloatExt();
			}
			case DiscordCoreInternal::ETFTokenType::Atom_Ext: {
				return this->parseAtomUtf8Ext();
			}
			case DiscordCoreInternal::ETFTokenType::Small_Tuple_Ext: {
				return this->parseSmallTupleExt();
			}
			case DiscordCoreInternal::ETFTokenType::Large_Tuple_Ext: {
				return this->parseLargeTupleExt();
			}
			case DiscordCoreInternal::ETFTokenType::Nil_Ext: {
				return this->parseNilExt();
			}
			case DiscordCoreInternal::ETFTokenType::String_Ext: {
				return this->parseStringAsList();
			}
			case DiscordCoreInternal::ETFTokenType::List_Ext: {
				return this->parseListExt();
			}
			case DiscordCoreInternal::ETFTokenType::Binary_Ext: {
				return this->parseBinaryExt();
			}
			case DiscordCoreInternal::ETFTokenType::Small_Big_Ext: {
				return this->parseSmallBigExt();
			}
			case DiscordCoreInternal::ETFTokenType::Large_Big_Ext: {
				return this->parseLargeBigExt();
			}
			case DiscordCoreInternal::ETFTokenType::Small_Atom_Ext: {
				return this->parseSmallAtomExt();
			}
			case DiscordCoreInternal::ETFTokenType::Map_Ext: {
				return this->parseMapExt();
			}
			case DiscordCoreInternal::ETFTokenType::Atom_Utf8_Ext: {
				return this->parseAtomUtf8Ext();
			}
			default: {
	...
	String ErlPacker::parseListExt() {
		...
		if (static_cast<DiscordCoreInternal::ETFTokenType > (theValue) != DiscordCoreInternal::ETFTokenType::Nil_Ext) {
			return String{};
		}
		return theArray;
	}
