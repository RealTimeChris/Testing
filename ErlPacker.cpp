...
#include "ErlPacker.hpp"
	...
	std::string ErlPacker::parseJsonToEtf(std::string& dataToParse) {
		...
		std::cout << "THE INPUT STRING: " << dataToParse << std::endl;
	...
	void ErlPacker::writeNumber(simdjson::ondemand::value jsonData) {
		...
		else if (jsonData.get_number_type() == simdjson::ondemand::number_type::signed_integer||jsonData.get_number_type()==simdjson::ondemand::number_type::unsigned_integer) {
